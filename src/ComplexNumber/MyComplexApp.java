...
public class MyComplexApp {
    public static void main(String[] args) {
        ...
        if (complex1.isImaginary())
            System.out.println("Number" + complex1 + "Is not imaginary");
        if (complex1.isReal())
            System.out.println("Number" + complex1 + "Is not real");
        System.out.println("Number 2 : " + complex2);
        if (complex2.isImaginary())
            System.out.println("Number" + complex2 + "Is not imaginary");
        if (complex2.isReal())
            System.out.println("Number" + complex2 + "Is not real");
